...
void IKSolver::fabrikSolver3d(std::vector<sf::Vector3f> &joints, const std::vector<float> &L, const sf::Vector3f &root, sf::Vector3f target, int maxIterations, float tol)
{
}
